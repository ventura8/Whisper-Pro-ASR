...
- **Minimum 5-Minute Sample**: Ensures that even short clips get up to 5 minutes of context for high-confidence identification — sampling is still capped at the source media's own duration, so a clip shorter than 5 minutes is sampled in full rather than padded or repeated.
