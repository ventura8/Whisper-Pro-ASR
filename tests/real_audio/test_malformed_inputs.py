...
def _malformed_params():
    ...
    return matrix_support.params_for_ids("adversarial", MALFORMED_IDS)
...
@pytest.mark.usefixtures("service_ready")
@pytest.mark.parametrize("case", matrix_support.params_for_ids("adversarial", {"silence_only", "sub_second_clip"}))
