...
def _load(unit: dict, env: Optional[dict] = None) -> str:
    ...
    # importlib rather than a function-level `import`: the deferral is required (see above)
    # and an import statement here would need ruff PLC0415 and pylint
    # import-outside-toplevel suppressions, which this repository bans.
    preprocessing = importlib.import_module("modules.inference.pipeline.preprocessing")
