...
def _format_diarized_segments(alignment_result):
...
def run_diarization(*, processed_path, raw_segments, info, language, min_speakers, max_speakers, hf_token, unit_id):
    ...
    alignment_result = whisperx.align(
        raw_segments, model_a, metadata, audio, device=whisperx_device, return_char_alignments=False
    )
