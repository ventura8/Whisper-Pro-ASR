...
# TWO levels up, as the comment above says: site-packages is <venv>/lib/pythonX.Y/site-packages,
# so one .parent lands on the pythonX.Y directory -- which holds no oneAPI libraries at all.
